    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <Link href="/signup" className="inline-flex items-center gap-2 rounded-full bg-foreground px-6 py-3 text-sm font-medium text-background">Get Started Free <ArrowRight className="h-4 w-4" /></Link>
          <Link href="/features" className="rounded-full border border-border bg-background px-6 py-3 text-sm font-medium">Explore Features</Link>
        </div>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
