    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="text-center">
        ...
        <p className="mx-auto mt-4 max-w-xl text-sm text-muted-foreground">
          LifeOS is built local-first with zero-knowledge encryption. Not us, not our servers, not a data broker — no one but you can read your notes, habits, or reflections.
        </p>
      </div>
      ...
      <div className="grid gap-12 md:grid-cols-2 md:items-center">
        <div>
          ...
          <p className="mt-4 max-w-md text-sm text-muted-foreground">
            LifeOS turns your journal, tasks, and habits into a searchable memory graph. Semantic embeddings (all-MiniLM-L6-v2) run entirely on-device, so you can ask questions in plain English and get answers in under 100ms — offline.
          </p>
...
const testimonials = [
  { name: "Amelia R.", role: "Product Designer", text: "The gap between what I planned and what I actually did used to haunt me. LifeOS quietly closed it.", avatar: 0 },
...
const defaultFaq = [
  { q: "Is LifeOS really offline-first?", a: "Yes. The app runs on your device against a local IndexedDB + WebAssembly SQLite store. You can create tasks, log habits, journal, and run semantic searches with no network at all." },
  ...
  { q: "Can I use LifeOS on multiple devices?", a: "Yes. Optional encrypted sync uses Last-Write-Wins with version checks. Ciphertext is all our servers ever see." },
